"""
Django settings for aaqa_47828 project.
...
WSGI_APPLICATION = "aaqa_47828.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aaqa_47828 API",
    "DESCRIPTION": "API documentation for aaqa_47828 App",
    "VERSION": "v1",
}
